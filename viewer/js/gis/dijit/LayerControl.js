define([
    ...
    var LayerControl = declare([WidgetBase, Container], {
        ...
        layerInfos: [],
        icons: {
            expand: 'fas fa-caret-right fa-fw layerControlIcon-Expand',
            collapse: 'fas fa-caret-down fa-fw layerControlIcon-Collapse',
        ...
        _removeLayer: function (layer) {
            topic.publish('layerLoader/removeLayer', layer);
        },
