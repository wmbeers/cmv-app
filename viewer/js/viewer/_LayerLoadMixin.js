define([
    ...
    return declare(null, {
        ...
        /**
        * Handles messages passed by postMessage to add a project to the map, zoom to a point, add a layer, etc.
        * @param {object} e Event generated by postMessage containing a data object with a command, and whatever 
        * other arguments are needed by the downstream function to be called
        * @returns {void}
        */
        _handleMessage: function (e) {
            switch (e.data.command) {
            case 'addProjectToMap':
                this.addProjectToMap(e.data.projectId);
                break;
            ...
            case 'addLayer':
                ...
                var layer = this.constructLayer(e.data.layerName),
                ...
                break;
            case 'loadMap':
                this.loadMap(e.data.savedMapId);
                break;
            default:
