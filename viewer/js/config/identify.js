define([
    ...
    var _projectServiceIdentifyConfig = {
    ...
    return {
        ...
        identifies: {
            previouslyReviewedProjectsService: _projectServiceIdentifyConfig,
            currentlyInReviewProjectsService: _projectServiceIdentifyConfig,
            eliminatedProjectsService: _projectServiceIdentifyConfig,
            draftProjectsService: _projectServiceIdentifyConfig
        }
    };
});
